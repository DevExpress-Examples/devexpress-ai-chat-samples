<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/851207927/26.1.3%2B)
...
This example adds a [DxAIChat](https://docs.devexpress.com/Blazor/DevExpress.AIIntegration.Blazor.Chat.DxAIChat) to a Blazor application, customizes its settings, and integrates it into WinForms, WPF, and .NET MAUI applications.
...
* [EmptyMessageAreaTemplate](https://docs.devexpress.com/Blazor/DevExpress.AIIntegration.Blazor.Chat.DxAIChat.EmptyMessageAreaTemplate) - specifies the template used for the empty message area.
...
To display rich formatted messages, set the [ResponseContentFormat](https://docs.devexpress.com/Blazor/DevExpress.AIIntegration.Blazor.Chat.DxAIChat.ResponseContentFormat) property to `Markdown`. Use a markdown processor to convert response content to HTML code.
...
For WinForms apps, use the WinForms `AIChatControl` control. Read the following help topic for additional information: [WinForms AI Chat Control Documentation](https://docs.devexpress.com/WindowsForms/405218/ai-powered-extensions/ai-chat-control).

For WPF apps, use the WPF `AIChatControl`. Read the following help topic for additional information: [WPF AI Chat Control Documentation](http://docs.devexpress.com/WPF/405434/ai-powered-extensions/ai-chat-control).

### Integrate AI Chat into .NET MAUI Apps

Thanks to both Blazor Hybrid technology and the BlazorWebView component, you can integrate DevExpress AI Chat ([DxAIChat](https://docs.devexpress.com/Blazor/DevExpress.AIIntegration.Blazor.Chat.DxAIChat)) into your .NET MAUI application. Keys to implementation are as follows:
